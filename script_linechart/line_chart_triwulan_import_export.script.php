...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#triwulan_import_export').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($triwulan_import_export_2021);
            while(($arus = oci_fetch_array($triwulan_import_export_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['TRIWULAN1'] . '",';
              echo '"' . $arus['TRIWULAN2'] . '",';
              echo '"' . $arus['TRIWULAN3'] . '",';
        ...
        },
        {
          ...
          data                :
            ...
            oci_execute($triwulan_import_export_2020);
            while(($arus = oci_fetch_array($triwulan_import_export_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['TRIWULAN1'] . '",';
              echo '"' . $arus['TRIWULAN2'] . '",';
              echo '"' . $arus['TRIWULAN3'] . '",';
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_triwulan_import_export').get(0).getContext('2d')
    ...
    var lineChart_triwulan_import_export = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
