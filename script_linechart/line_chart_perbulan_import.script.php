...
<script>
  $(function () {
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            $perbulan_import_2021 = oci_parse($koneksi,     
              " 
              SELECT (if20+if40+if45+ie20+ie40+ie45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2021' and Lokasi='Internasional' order by ID asc
              "
            );
        ...
        },
        {
          ...
          data                :
            ...
            $perbulan_import_2020 = oci_parse($koneksi,     
              " 
              SELECT (if20+if40+if45+ie20+ie40+ie45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2020' and Lokasi='Internasional' order by ID asc
              "
            );
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_perbulan_import').get(0).getContext('2d')
    ...
    var lineChart_perbulan_import = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
