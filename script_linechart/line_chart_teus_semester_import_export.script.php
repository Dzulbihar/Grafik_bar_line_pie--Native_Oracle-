...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#teus_semester_import_export').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($teus_semester_import_export_2021);
            while(($arus = oci_fetch_array($teus_semester_import_export_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
        ...
        },
        {
          ...
          data                :
            ...
            oci_execute($teus_semester_import_export_2020);
            while(($arus = oci_fetch_array($teus_semester_import_export_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_teus_semester_import_export').get(0).getContext('2d')
    ...
    var lineChart_teus_semester_import_export = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
