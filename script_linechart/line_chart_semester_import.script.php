...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#semester_import').get(0).getContext('2d')
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_semester_import').get(0).getContext('2d')
    ...
    var lineChart_semester_import = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
