...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#semester_export').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($semester_import_2021);
            while(($arus = oci_fetch_array($semester_import_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
        ...
        },
        {
          ...
          data                :
            ...
            oci_execute($semester_import_2020);
            while(($arus = oci_fetch_array($semester_import_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_semester_export').get(0).getContext('2d')
    ...
    var lineChart_semester_export = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
