...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#teus_triwulan_import_export').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($teus_triwulan_import_export_2021);
            while(($arus = oci_fetch_array($teus_triwulan_import_export_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['TRIWULAN1'] . '",';
              echo '"' . $arus['TRIWULAN2'] . '",';
              echo '"' . $arus['TRIWULAN3'] . '",';
        ...
        },
        {
          ...
          data                :
            ...
            oci_execute($teus_triwulan_import_export_2020);
            while(($arus = oci_fetch_array($teus_triwulan_import_export_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['TRIWULAN1'] . '",';
              echo '"' . $arus['TRIWULAN2'] . '",';
              echo '"' . $arus['TRIWULAN3'] . '",';
    ...
    //- LINE CHART -
    //--------------
    var lineChartCanvas = $('#lineChart_teus_triwulan_import_export').get(0).getContext('2d')
    ...
    var lineChart_teus_triwulan_import_export = new Chart(lineChartCanvas, {
      type: 'line',
      data: lineChartData,
