...
<script>
  $(function () {
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($semester_export_2021);
            while(($arus = oci_fetch_array($semester_export_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
        ...
        },
        {
          ...
          data                : 
            ...
            oci_execute($semester_export_2020);
            while(($arus = oci_fetch_array($semester_export_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['SEMESTER1'] . '",';
              echo '"' . $arus['SEMESTER2'] . '",';
            }
    ...
    //- BAR CHART -
    //-------------
    var barChartCanvas = $('#barChart_semester_export').get(0).getContext('2d')
