...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#pertahun_import').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($pertahun_import_2021);
            while(($arus = oci_fetch_array($pertahun_import_2021, OCI_BOTH)) != false)
            {
              echo '"' . $arus['PERTAHUN'] . '",';
            }
        ...
        },
        {
          ...
          data                : 
            ...
            oci_execute($pertahun_import_2020);
            while(($arus = oci_fetch_array($pertahun_import_2020, OCI_BOTH)) != false)
            {
              echo '"' . $arus['PERTAHUN'] . '",';
            }
    ...
    //- BAR CHART -
    //-------------
    var barChartCanvas = $('#barChart_pertahun_import').get(0).getContext('2d')
