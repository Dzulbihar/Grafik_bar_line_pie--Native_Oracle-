...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#teus_pertahun_export').get(0).getContext('2d')
      ...
      datasets: [
        {
          ...
          data                : 
            ...
            oci_execute($teus_pertahun_export_2021);
            while(($arus = oci_fetch_array($teus_pertahun_export_2021, OCI_BOTH)) != false)
            {
    ...
    //- BAR CHART -
    //-------------
    var barChartCanvas = $('#barChart_teus_pertahun_export').get(0).getContext('2d')
