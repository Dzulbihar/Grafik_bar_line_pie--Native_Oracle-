...
////////////////////////////////////////////////////////////
// perbulan_import
  $perbulan_import_2020  = oci_parse($koneksi, "SELECT (if20+if40+if45+ie20+ie40+ie45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2020' and Lokasi='Internasional' order by ID asc");
  $perbulan_import_2021  = oci_parse($koneksi, "SELECT (if20+if40+if45+ie20+ie40+ie45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2021' and Lokasi='Internasional' order by ID asc");
...
// perbulan_export
  $perbulan_export_2020  = oci_parse($koneksi, "SELECT (ef20+ef40+ef45+ee20+ee40+ee45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2020' and Lokasi='Internasional' order by ID asc");
  $perbulan_export_2021  = oci_parse($koneksi, "SELECT (ef20+ef40+ef45+ee20+ee40+ee45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2021' and Lokasi='Internasional' order by ID asc");
...
// perbulan_import_export
  $perbulan_import_export_2020  = oci_parse($koneksi, "SELECT (if20+if40+if45+ie20+ie40+ie45+ef20+ef40+ef45+ee20+ee40+ee45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2020' and Lokasi='Internasional' order by ID asc");
  $perbulan_import_export_2021  = oci_parse($koneksi, "SELECT (if20+if40+if45+ie20+ie40+ie45+ef20+ef40+ef45+ee20+ee40+ee45) as total_box FROM ARUS_BONGKAR_MUAT where Tahun='2021' and Lokasi='Internasional' order by ID asc");
